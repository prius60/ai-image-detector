...
def train_on_dataset(save_path, dataset_path, criterion, num_epochs=5, model_path=None):
    ...
    model = ViT_Res()  # Assuming ViTModel is already defined.
...
# train_on_dataset('ViT_Res_weights/midjourney_model.pth', 'resized_images/imagenet_midjourney', criterion, num_epochs=3)
# train_on_dataset('ViT_Res_weights/sdv5_model.pth', 'resized_images/imagenet_ai_0424_sdv5', criterion, num_epochs=3)
# train_on_dataset('ViT_Res_weights/glide_model.pth', 'resized_images/imagenet_glide', criterion, num_epochs=3)
train_on_dataset('ViT_Res_weights/adm_model.pth', 'resized_images/imagenet_ai_0508_adm', criterion, num_epochs=3)
train_on_dataset('ViT_Res_weights/vqdm_model.pth', 'resized_images/imagenet_ai_0419_vqdm', criterion, num_epochs=3)
train_on_dataset('ViT_Res_weights/wukong_model.pth', 'resized_images/imagenet_ai_0424_wukong', criterion, num_epochs=3)
train_on_dataset('ViT_Res_weights/sdv4_model.pth', 'resized_images/imagenet_ai_0419_sdv4', criterion, num_epochs=3)
train_on_dataset('ViT_Res_weights/biggan_model.pth', 'resized_images/imagenet_ai_0419_biggan', criterion, num_epochs=3) 
...
models_directory = './ViT_Res_weights'

evaluate_all_ViT_Res(root_directory, models_directory)